...
\n Tappet om 13.4.", liters: 60)

# Brewing name:string brewers:string batch_number:integer strength:float original_gravity:float final_gravity:float notes:text date:date liters:integer
